...
prefix `2xyz:ispX:a000::/36` from its regional registry, and provider Y
has obtained `2zyx:ispY:a000::/36`. Suppose our enterprise has then been
assigned `2xyz:ispX:abcd::/48` from X, and `2zyx:ispY:a123::/48` from Y.
...
`2xyz:ispX:abcd:0101::/64` and `2zyx:ispY:a123:0101::/64`. Therefore,
...
addresses `2xyz:ispX:abcd:0101::abc1` and `2zyx:ispY:a123:0101::def2`.
...
that traffic from `2xyz:ispX:abcd:0101::abc1` exits the site towards ISP
X, and traffic from `2zyx:ispY:a123:0101::def2` exits towards ISP Y.
